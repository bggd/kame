...
static void initMatrix(py::module& m)
{
    ...
    py::class_<Matrix>(m, "Matrix")
        ...
        .def("createTranslation", py::overload_cast<Vector3>(&Matrix::createTranslation))
        .def("createTranslation", py::overload_cast<float, float, float>(&Matrix::createTranslation))
        ...
        .def("createScale", py::overload_cast<Vector3>(&Matrix::createScale))
        .def("createScale", py::overload_cast<float>(&Matrix::createScale))
        .def("createScale", py::overload_cast<float, float, float>(&Matrix::createScale))
